  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div><span className="footer-label">Participar</span><Link href="/join">Crear perfil</Link><Link href="/dashboard">Dashboard demo</Link><Link href="/admin">Administración</Link></div>
